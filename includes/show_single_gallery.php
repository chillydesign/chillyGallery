...
foreach ($images as $image) : 
	...
	$chill_gall .= '<li class="image_container"> 

		<a title="' .  $image->post_excerpt  . '"  class="fancybox" rel="group_' .  $gallery->ID  . '" href=" . ' $url . '">' . wp_get_attachment_image(  $thumb , $thumbnail_size ) .  '</a>
